...
; ------------------------------------------------------------
; ---------- Half_adder___contract_unsatisfiable__Half_adder_EncodedGlobalVariables_Main ----------
...
(push) ; 2
; [exec]
; inhale true && (acc(diz.Main_half, wildcard) && diz.Main_half != null && acc(diz.Main_half.Half_adder_m, 1 / 2) && diz.Main_half.Half_adder_m == diz && acc(diz.Main_half.Half_adder_init, 1 / 2) && !diz.Main_half.Half_adder_init && acc(Half_adder_idleToken_EncodedGlobalVariables(diz.Main_half, globals), write))
...
(assert (implies (< $Perm.No $k@14@08) (not (= diz@10@08 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second $t@13@08))
  ($Snap.combine
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@08))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@08)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@08))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@08)))))))
  $Snap.unit))

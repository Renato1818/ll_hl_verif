...
; [exec]
; diz__1 := new(Sensor_m, Sensor_init, Sensor_dist)
(declare-const diz__1@8@07 $Ref)
(assert (not (= diz__1@8@07 $Ref.null)))
(declare-const Sensor_m@9@07 $Ref)
(declare-const Sensor_init@10@07 Bool)
(declare-const Sensor_dist@11@07 Int)
(assert (not (= diz__1@8@07 m0@4@07)))
...
(declare-const $t@12@07 $Snap)
(assert (= $t@12@07 $Snap.unit))
...
; [exec]
; // assert
; assert sys__result != null && type_of(sys__result) == class_Sensor() && acc(Sensor_idleToken_EncodedGlobalVariables(sys__result, globals), write) && acc(sys__result.Sensor_m, write) && sys__result.Sensor_m == m0 && acc(sys__result.Sensor_dist, write) && acc(sys__result.Sensor_init, write) && !sys__result.Sensor_init
; [eval] sys__result != null
; [eval] type_of(sys__result) == class_Sensor()
; [eval] type_of(sys__result)
; [eval] class_Sensor()
...
(declare-const diz@14@07 $Ref)
(declare-const globals@15@07 $Ref)
(declare-const diz@16@07 $Ref)
(declare-const globals@17@07 $Ref)
(push) ; 1
(declare-const $t@18@07 $Snap)
(assert (= $t@18@07 $Snap.unit))
; [eval] diz != null
(assert (not (= diz@16@07 $Ref.null)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 1
(declare-const $t@25@07 $Snap)
(assert (= $t@25@07 ($Snap.combine ($Snap.first $t@25@07) ($Snap.second $t@25@07))))
(assert (= ($Snap.first $t@25@07) $Snap.unit))
; [eval] diz != null
(assert (not (= diz@23@07 $Ref.null)))
(assert (=
  ($Snap.second $t@25@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@25@07))
    ($Snap.second ($Snap.second $t@25@07)))))
(assert (=
  ($Snap.second ($Snap.second $t@25@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@25@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@25@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@25@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@25@07))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07)))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07)))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@26@07 | live]
; [else-branch: 0 | !(0 <= i@26@07) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@26@07]
(assert (<= 0 i@26@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@26@07)]
(assert (not (<= 0 i@26@07)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@26@07 < |First:(Second:(Second:($t@25@07)))| && 0 <= i@26@07 | live]
; [else-branch: 1 | !(i@26@07 < |First:(Second:(Second:($t@25@07)))| && 0 <= i@26@07) | live]
(push) ; 4
; [then-branch: 1 | i@26@07 < |First:(Second:(Second:($t@25@07)))| && 0 <= i@26@07]
(assert (and
  (<
    i@26@07
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@25@07)))[i@26@07] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@25@07)))[i@26@07] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@25@07)))[i@26@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
    i@26@07)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@25@07)))[i@26@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
...
;  :rlimit-count            115511)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@25@07)))[i@26@07] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@25@07)))[i@26@07]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@25@07)))[i@26@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@25@07)))[i@26@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@26@07 < |First:(Second:(Second:($t@25@07)))| && 0 <= i@26@07)]
(assert (not
  (and
    (<
      i@26@07
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@27@07))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@27@07)))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@28@07 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@28@07 | live]
; [else-branch: 4 | !(0 <= i@28@07) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@28@07]
(assert (<= 0 i@28@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@28@07)]
(assert (not (<= 0 i@28@07)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@28@07 < |First:(Second:($t@27@07))| && 0 <= i@28@07 | live]
; [else-branch: 5 | !(i@28@07 < |First:(Second:($t@27@07))| && 0 <= i@28@07) | live]
(push) ; 5
; [then-branch: 5 | i@28@07 < |First:(Second:($t@27@07))| && 0 <= i@28@07]
(assert (and
  (<
    i@28@07
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@27@07))[i@28@07] == -1 | live]
; [else-branch: 6 | First:(Second:($t@27@07))[i@28@07] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@27@07))[i@28@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@27@07)))
    i@28@07)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@27@07))[i@28@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@27@07)))
...
;  :rlimit-count            117564)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@27@07))[i@28@07] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@27@07))[i@28@07]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@27@07))[i@28@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@27@07)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@27@07))[i@28@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@28@07 < |First:(Second:($t@27@07))| && 0 <= i@28@07)]
(assert (not
  (and
    (<
      i@28@07
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))
  $Snap.unit))
...
;  :rlimit-count            118728)
(push) ; 3
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@25@07)))[0] | live]
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@25@07)))[0]) | live]
(push) ; 4
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@25@07)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
...
;  :rlimit-count            119008)
(push) ; 5
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 | live]
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] != 0 | live]
(push) ; 6
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@25@07)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            120801
;  :time                    0.00)
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0] | live]
; [else-branch: 10 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0]) | live]
(push) ; 4
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0]]
(assert (and
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0])]
(assert (not
  (and
    (or
      (=
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))))
  $Snap.unit))
...
;  :rlimit-count            121564)
(push) ; 3
; [then-branch: 11 | 0 <= First:(Second:(Second:($t@25@07)))[1] | live]
; [else-branch: 11 | !(0 <= First:(Second:(Second:($t@25@07)))[1]) | live]
(push) ; 4
; [then-branch: 11 | 0 <= First:(Second:(Second:($t@25@07)))[1]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
...
;  :rlimit-count            121842)
(push) ; 5
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 | live]
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] != 0 | live]
(push) ; 6
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | !(0 <= First:(Second:(Second:($t@25@07)))[1])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            123799
;  :time                    0.00)
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1] | live]
; [else-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1]) | live]
(push) ; 4
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1]]
(assert (and
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1])]
(assert (not
  (and
    (or
      (=
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@27@07))))))))))
  $Snap.unit))
...
;  :rlimit-count            124572)
(push) ; 3
; [then-branch: 14 | 0 <= First:(Second:(Second:($t@25@07)))[0] | live]
; [else-branch: 14 | !(0 <= First:(Second:(Second:($t@25@07)))[0]) | live]
(push) ; 4
; [then-branch: 14 | 0 <= First:(Second:(Second:($t@25@07)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
...
;  :rlimit-count            124806)
(push) ; 5
; [then-branch: 15 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 | live]
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] != 0 | live]
(push) ; 6
; [then-branch: 15 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 14 | !(0 <= First:(Second:(Second:($t@25@07)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            126767
;  :time                    0.00)
; [then-branch: 16 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0]) | live]
; [else-branch: 16 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0] | live]
(push) ; 4
; [then-branch: 16 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0])]
(assert (not
  (and
    (or
      (=
...
(pop) ; 4
(push) ; 4
; [else-branch: 16 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[0]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[0]]
(assert (and
  (or
    (=
      (Seq_index
...
;  :rlimit-count            127440)
(push) ; 3
; [then-branch: 17 | 0 <= First:(Second:(Second:($t@25@07)))[1] | live]
; [else-branch: 17 | !(0 <= First:(Second:(Second:($t@25@07)))[1]) | live]
(push) ; 4
; [then-branch: 17 | 0 <= First:(Second:(Second:($t@25@07)))[1]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@25@07))))
...
;  :rlimit-count            127674)
(push) ; 5
; [then-branch: 18 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 | live]
; [else-branch: 18 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] != 0 | live]
(push) ; 6
; [then-branch: 18 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 18 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@25@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 17 | !(0 <= First:(Second:(Second:($t@25@07)))[1])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            129741
;  :time                    0.00)
; [then-branch: 19 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1]) | live]
; [else-branch: 19 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1] | live]
(push) ; 4
; [then-branch: 19 | !(First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1])]
(assert (not
  (and
    (or
      (=
...
(pop) ; 4
(push) ; 4
; [else-branch: 19 | First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@25@07)))))[First:(Second:(Second:($t@25@07)))[1]] == -1 && 0 <= First:(Second:(Second:($t@25@07)))[1]]
(assert (and
  (or
    (=
      (Seq_index

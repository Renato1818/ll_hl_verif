...
; [eval] 0 <= i__11
(push) ; 4
; [then-branch: 0 | 0 <= i__11@14@04 | live]
; [else-branch: 0 | !(0 <= i__11@14@04) | live]
(push) ; 5
; [then-branch: 0 | 0 <= i__11@14@04]
(assert (<= 0 i__11@14@04))
; [eval] i__11 < |diz.ALU_m.Main_process_state|
; [eval] |diz.ALU_m.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 0 | !(0 <= i__11@14@04)]
(assert (not (<= 0 i__11@14@04)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 1 | i__11@14@04 < |First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))| && 0 <= i__11@14@04 | live]
; [else-branch: 1 | !(i__11@14@04 < |First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))| && 0 <= i__11@14@04) | live]
(push) ; 5
; [then-branch: 1 | i__11@14@04 < |First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))| && 0 <= i__11@14@04]
(assert (and
  (<
    i__11@14@04
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04] != -1 | live]
(push) ; 7
; [then-branch: 2 | First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@04))))))))
    i__11@14@04)
...
(pop) ; 7
(push) ; 7
; [else-branch: 2 | First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@04))))))))
...
;  :rlimit-count          110351)
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04]) | live]
(push) ; 9
; [then-branch: 3 | 0 <= First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@04))))))))
...
(pop) ; 9
(push) ; 9
; [else-branch: 3 | !(0 <= First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))[i__11@14@04])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(i__11@14@04 < |First:(Second:(Second:(Second:(Second:(Second:(Second:($t@13@04)))))))| && 0 <= i__11@14@04)]
(assert (not
  (and
    (<
      i__11@14@04
...
;  :rlimit-count          115693)
(assert (=
  ($SortWrappers.$SnapToBool ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@04)))))))))))))))))))))))
...
(declare-const diz@16@04 $Ref)
(declare-const globals@17@04 $Ref)
(declare-const diz@18@04 $Ref)
(declare-const globals@19@04 $Ref)
(push) ; 1
(declare-const $t@20@04 $Snap)
(assert (= $t@20@04 ($Snap.combine ($Snap.first $t@20@04) ($Snap.second $t@20@04))))
(assert (= ($Snap.first $t@20@04) $Snap.unit))
; [eval] diz != null
(assert (not (= diz@18@04 $Ref.null)))
(assert (=
  ($Snap.second $t@20@04)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@20@04))
    ($Snap.second ($Snap.second $t@20@04)))))
(assert (=
  ($Snap.second ($Snap.second $t@20@04))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@20@04)))
    ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@20@04)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@04))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@20@04))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@20@04)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04)))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 4 | 0 <= i@21@04 | live]
; [else-branch: 4 | !(0 <= i@21@04) | live]
(push) ; 4
; [then-branch: 4 | 0 <= i@21@04]
(assert (<= 0 i@21@04))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 4 | !(0 <= i@21@04)]
(assert (not (<= 0 i@21@04)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 5 | i@21@04 < |First:(Second:(Second:($t@20@04)))| && 0 <= i@21@04 | live]
; [else-branch: 5 | !(i@21@04 < |First:(Second:(Second:($t@20@04)))| && 0 <= i@21@04) | live]
(push) ; 4
; [then-branch: 5 | i@21@04 < |First:(Second:(Second:($t@20@04)))| && 0 <= i@21@04]
(assert (and
  (<
    i@21@04
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 6 | First:(Second:(Second:($t@20@04)))[i@21@04] == -1 | live]
; [else-branch: 6 | First:(Second:(Second:($t@20@04)))[i@21@04] != -1 | live]
(push) ; 6
; [then-branch: 6 | First:(Second:(Second:($t@20@04)))[i@21@04] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@20@04))))
    i@21@04)
...
(pop) ; 6
(push) ; 6
; [else-branch: 6 | First:(Second:(Second:($t@20@04)))[i@21@04] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@20@04))))
...
;  :rlimit-count            119450)
(push) ; 7
; [then-branch: 7 | 0 <= First:(Second:(Second:($t@20@04)))[i@21@04] | live]
; [else-branch: 7 | !(0 <= First:(Second:(Second:($t@20@04)))[i@21@04]) | live]
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:(Second:($t@20@04)))[i@21@04]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@20@04))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 7 | !(0 <= First:(Second:(Second:($t@20@04)))[i@21@04])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 5 | !(i@21@04 < |First:(Second:(Second:($t@20@04)))| && 0 <= i@21@04)]
(assert (not
  (and
    (<
      i@21@04
...
; unknown
(push) ; 2
(declare-const $t@22@04 $Snap)
(assert (= $t@22@04 ($Snap.combine ($Snap.first $t@22@04) ($Snap.second $t@22@04))))
(assert (=
  ($Snap.second $t@22@04)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@22@04))
    ($Snap.second ($Snap.second $t@22@04)))))
(assert (=
  ($Snap.second ($Snap.second $t@22@04))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@22@04)))
    ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@22@04))) $Snap.unit))
; [eval] |diz.Main_process_state| == 1
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@22@04))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@22@04)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@22@04))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))
  $Snap.unit))
; [eval] |diz.Main_event_state| == 2
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@23@04 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 8 | 0 <= i@23@04 | live]
; [else-branch: 8 | !(0 <= i@23@04) | live]
(push) ; 5
; [then-branch: 8 | 0 <= i@23@04]
(assert (<= 0 i@23@04))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 8 | !(0 <= i@23@04)]
(assert (not (<= 0 i@23@04)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 9 | i@23@04 < |First:(Second:($t@22@04))| && 0 <= i@23@04 | live]
; [else-branch: 9 | !(i@23@04 < |First:(Second:($t@22@04))| && 0 <= i@23@04) | live]
(push) ; 5
; [then-branch: 9 | i@23@04 < |First:(Second:($t@22@04))| && 0 <= i@23@04]
(assert (and
  (<
    i@23@04
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 10 | First:(Second:($t@22@04))[i@23@04] == -1 | live]
; [else-branch: 10 | First:(Second:($t@22@04))[i@23@04] != -1 | live]
(push) ; 7
; [then-branch: 10 | First:(Second:($t@22@04))[i@23@04] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@22@04)))
    i@23@04)
...
(pop) ; 7
(push) ; 7
; [else-branch: 10 | First:(Second:($t@22@04))[i@23@04] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@22@04)))
...
;  :rlimit-count            121504)
(push) ; 8
; [then-branch: 11 | 0 <= First:(Second:($t@22@04))[i@23@04] | live]
; [else-branch: 11 | !(0 <= First:(Second:($t@22@04))[i@23@04]) | live]
(push) ; 9
; [then-branch: 11 | 0 <= First:(Second:($t@22@04))[i@23@04]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@22@04)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 11 | !(0 <= First:(Second:($t@22@04))[i@23@04])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 9 | !(i@23@04 < |First:(Second:($t@22@04))| && 0 <= i@23@04)]
(assert (not
  (and
    (<
      i@23@04
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))
  $Snap.unit))
...
;  :rlimit-count            123824
;  :time                    0.00)
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] == 0 | live]
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] != 0 | live]
(push) ; 4
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
    0)
...
(pop) ; 4
(push) ; 4
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))))
  $Snap.unit))
...
;  :rlimit-count            125652
;  :time                    0.00)
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] == 0 | live]
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] != 0 | live]
(push) ; 4
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
    1)
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@22@04))))))))))
  $Snap.unit))
...
;  :rlimit-count            127533
;  :time                    0.00)
; [then-branch: 14 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] != 0 | live]
; [else-branch: 14 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] == 0 | live]
(push) ; 4
; [then-branch: 14 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 14 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
    0)
...
;  :rlimit-count            129303
;  :time                    0.00)
; [then-branch: 15 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] != 0 | live]
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] == 0 | live]
(push) ; 4
; [then-branch: 15 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@20@04)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@20@04))))))
    1)

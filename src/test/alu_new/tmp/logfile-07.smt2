...
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))
  0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))
  ($Snap.combine
...
(assert (not
  ($SortWrappers.$SnapToBool ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))
  ($Snap.combine
...
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))))
  0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07)))))))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07)))))))))))))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07)))))))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07)))))))))))))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07))))))))))))))))))
  $Snap.unit))
; [eval] !sys__result.ALU_init
(assert (not
  ($SortWrappers.$SnapToBool ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@6@07)))))))))))))))))))))
(pop) ; 2
(push) ; 2
; [exec]
; var diz__1: Ref
...
; [exec]
; diz__1 := new(ALU_m, ALU_OPCODE, ALU_OP1, ALU_OP2, ALU_CARRY, ALU_ZERO, ALU_RESULT, ALU_init)
...
(declare-const ALU_init@16@07 Bool)
...
; diz__1.ALU_RESULT := 0
; [exec]
; diz__1.ALU_init := false
; [exec]
; inhale acc(ALU_idleToken_EncodedGlobalVariables(diz__1, globals), write)
(declare-const $t@18@07 $Snap)
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
; [exec]
; // assert
; assert sys__result != null && type_of(sys__result) == class_ALU() && acc(ALU_idleToken_EncodedGlobalVariables(sys__result, globals), write) && acc(sys__result.ALU_m, write) && acc(sys__result.ALU_OPCODE, write) && sys__result.ALU_OPCODE == 0 && acc(sys__result.ALU_OP1, write) && sys__result.ALU_OP1 == 0 && acc(sys__result.ALU_OP2, write) && sys__result.ALU_OP2 == 0 && acc(sys__result.ALU_CARRY, write) && !sys__result.ALU_CARRY && acc(sys__result.ALU_ZERO, write) && !sys__result.ALU_ZERO && acc(sys__result.ALU_RESULT, write) && sys__result.ALU_RESULT == 0 && sys__result.ALU_m == m_param && acc(sys__result.ALU_init, write) && !sys__result.ALU_init
; [eval] sys__result != null
; [eval] type_of(sys__result) == class_ALU()
; [eval] type_of(sys__result)
; [eval] class_ALU()
...
(push) ; 2
; [exec]
; inhale true && (acc(diz.Main_alu, wildcard) && diz.Main_alu != null && acc(diz.Main_alu.ALU_m, 1 / 2) && diz.Main_alu.ALU_m == diz && acc(diz.Main_alu.ALU_init, 1 / 2) && !diz.Main_alu.ALU_init && acc(ALU_idleToken_EncodedGlobalVariables(diz.Main_alu, globals), write))
...
(assert (implies (< $Perm.No $k@25@07) (not (= diz@21@07 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second $t@24@07))
  ($Snap.combine
...
(declare-const diz@28@07 $Ref)
(declare-const globals@29@07 $Ref)
(push) ; 1
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@30@07)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@07))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@07)))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@07))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@31@07 | live]
; [else-branch: 0 | !(0 <= i@31@07) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@31@07]
(assert (<= 0 i@31@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@31@07)]
(assert (not (<= 0 i@31@07)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@31@07 < |First:(Second:(Second:($t@30@07)))| && 0 <= i@31@07 | live]
; [else-branch: 1 | !(i@31@07 < |First:(Second:(Second:($t@30@07)))| && 0 <= i@31@07) | live]
(push) ; 4
; [then-branch: 1 | i@31@07 < |First:(Second:(Second:($t@30@07)))| && 0 <= i@31@07]
(assert (and
  (<
    i@31@07
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@30@07)))[i@31@07] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@30@07)))[i@31@07] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@30@07)))[i@31@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@30@07))))
    i@31@07)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@30@07)))[i@31@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@30@07))))
...
;  :rlimit-count            114272)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@30@07)))[i@31@07] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@30@07)))[i@31@07]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@30@07)))[i@31@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@30@07))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@30@07)))[i@31@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@31@07 < |First:(Second:(Second:($t@30@07)))| && 0 <= i@31@07)]
(assert (not
  (and
    (<
      i@31@07
...
; unknown
(push) ; 2
(declare-const $t@32@07 $Snap)
(assert (= $t@32@07 ($Snap.combine ($Snap.first $t@32@07) ($Snap.second $t@32@07))))
(assert (=
  ($Snap.second $t@32@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@32@07))
    ($Snap.second ($Snap.second $t@32@07)))))
(assert (=
  ($Snap.second ($Snap.second $t@32@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@32@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@32@07))) $Snap.unit))
; [eval] |diz.Main_process_state| == 1
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@32@07))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@32@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@32@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))
  $Snap.unit))
; [eval] |diz.Main_event_state| == 2
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@33@07 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@33@07 | live]
; [else-branch: 4 | !(0 <= i@33@07) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@33@07]
(assert (<= 0 i@33@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@33@07)]
(assert (not (<= 0 i@33@07)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@33@07 < |First:(Second:($t@32@07))| && 0 <= i@33@07 | live]
; [else-branch: 5 | !(i@33@07 < |First:(Second:($t@32@07))| && 0 <= i@33@07) | live]
(push) ; 5
; [then-branch: 5 | i@33@07 < |First:(Second:($t@32@07))| && 0 <= i@33@07]
(assert (and
  (<
    i@33@07
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@32@07))[i@33@07] == -1 | live]
; [else-branch: 6 | First:(Second:($t@32@07))[i@33@07] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@32@07))[i@33@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@32@07)))
    i@33@07)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@32@07))[i@33@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@32@07)))
...
;  :rlimit-count            116325)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@32@07))[i@33@07] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@32@07))[i@33@07]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@32@07))[i@33@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@32@07)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@32@07))[i@33@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@33@07 < |First:(Second:($t@32@07))| && 0 <= i@33@07)]
(assert (not
  (and
    (<
      i@33@07
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))))))
  $Snap.unit))
...
;  :rlimit-count            117489)
(push) ; 3
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@30@07)))[0] | live]
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@30@07)))[0]) | live]
(push) ; 4
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@30@07)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@30@07))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@30@07)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            119224
;  :time                    0.00)
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0] | live]
; [else-branch: 9 | !(First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0]) | live]
(push) ; 4
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 9 | !(First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0])]
(assert (not
  (and
    (=
      (Seq_index
...
;  :rlimit-count            119825)
(push) ; 3
; [then-branch: 10 | 0 <= First:(Second:(Second:($t@30@07)))[0] | live]
; [else-branch: 10 | !(0 <= First:(Second:(Second:($t@30@07)))[0]) | live]
(push) ; 4
; [then-branch: 10 | 0 <= First:(Second:(Second:($t@30@07)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@30@07))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(0 <= First:(Second:(Second:($t@30@07)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            121639
;  :time                    0.00)
; [then-branch: 11 | !(First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0]) | live]
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0] | live]
(push) ; 4
; [then-branch: 11 | !(First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0])]
(assert (not
  (and
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@30@07)))))[First:(Second:(Second:($t@30@07)))[0]] == 0 && 0 <= First:(Second:(Second:($t@30@07)))[0]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@07))))))
...
(assert (= $t@38@07 ($Snap.combine ($Snap.first $t@38@07) ($Snap.second $t@38@07))))
(assert (= ($Snap.first $t@38@07) $Snap.unit))
; [eval] diz != null
(assert (not (= diz@36@07 $Ref.null)))
(assert (=
  ($Snap.second $t@38@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@38@07))
    ($Snap.second ($Snap.second $t@38@07)))))
(assert (=
  ($Snap.second ($Snap.second $t@38@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@38@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@38@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@38@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@38@07))))
  $Snap.unit))
; [eval] |diz.Main_process_state| == 1
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@38@07)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
  $Snap.unit))
; [eval] |diz.Main_event_state| == 2
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07)))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@39@07 Int)
(push) ; 2
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 3
; [then-branch: 12 | 0 <= i@39@07 | live]
; [else-branch: 12 | !(0 <= i@39@07) | live]
(push) ; 4
; [then-branch: 12 | 0 <= i@39@07]
(assert (<= 0 i@39@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 12 | !(0 <= i@39@07)]
(assert (not (<= 0 i@39@07)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 13 | i@39@07 < |First:(Second:(Second:($t@38@07)))| && 0 <= i@39@07 | live]
; [else-branch: 13 | !(i@39@07 < |First:(Second:(Second:($t@38@07)))| && 0 <= i@39@07) | live]
(push) ; 4
; [then-branch: 13 | i@39@07 < |First:(Second:(Second:($t@38@07)))| && 0 <= i@39@07]
(assert (and
  (<
    i@39@07
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 14 | First:(Second:(Second:($t@38@07)))[i@39@07] == -1 | live]
; [else-branch: 14 | First:(Second:(Second:($t@38@07)))[i@39@07] != -1 | live]
(push) ; 6
; [then-branch: 14 | First:(Second:(Second:($t@38@07)))[i@39@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@38@07))))
    i@39@07)
...
(pop) ; 6
(push) ; 6
; [else-branch: 14 | First:(Second:(Second:($t@38@07)))[i@39@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@38@07))))
...
;  :rlimit-count            123241)
(push) ; 7
; [then-branch: 15 | 0 <= First:(Second:(Second:($t@38@07)))[i@39@07] | live]
; [else-branch: 15 | !(0 <= First:(Second:(Second:($t@38@07)))[i@39@07]) | live]
(push) ; 8
; [then-branch: 15 | 0 <= First:(Second:(Second:($t@38@07)))[i@39@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@38@07))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 15 | !(0 <= First:(Second:(Second:($t@38@07)))[i@39@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | !(i@39@07 < |First:(Second:(Second:($t@38@07)))| && 0 <= i@39@07)]
(assert (not
  (and
    (<
      i@39@07
...
(assert (=
  ($Snap.second $t@40@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@40@07))
    ($Snap.second ($Snap.second $t@40@07)))))
(assert (=
  ($Snap.second ($Snap.second $t@40@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@40@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@40@07))) $Snap.unit))
; [eval] |diz.Main_process_state| == 1
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@40@07))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@40@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@40@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))
  $Snap.unit))
; [eval] |diz.Main_event_state| == 2
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@41@07 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 16 | 0 <= i@41@07 | live]
; [else-branch: 16 | !(0 <= i@41@07) | live]
(push) ; 5
; [then-branch: 16 | 0 <= i@41@07]
(assert (<= 0 i@41@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 16 | !(0 <= i@41@07)]
(assert (not (<= 0 i@41@07)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 17 | i@41@07 < |First:(Second:($t@40@07))| && 0 <= i@41@07 | live]
; [else-branch: 17 | !(i@41@07 < |First:(Second:($t@40@07))| && 0 <= i@41@07) | live]
(push) ; 5
; [then-branch: 17 | i@41@07 < |First:(Second:($t@40@07))| && 0 <= i@41@07]
(assert (and
  (<
    i@41@07
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 18 | First:(Second:($t@40@07))[i@41@07] == -1 | live]
; [else-branch: 18 | First:(Second:($t@40@07))[i@41@07] != -1 | live]
(push) ; 7
; [then-branch: 18 | First:(Second:($t@40@07))[i@41@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@40@07)))
    i@41@07)
...
(pop) ; 7
(push) ; 7
; [else-branch: 18 | First:(Second:($t@40@07))[i@41@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@40@07)))
...
;  :rlimit-count            125295)
(push) ; 8
; [then-branch: 19 | 0 <= First:(Second:($t@40@07))[i@41@07] | live]
; [else-branch: 19 | !(0 <= First:(Second:($t@40@07))[i@41@07]) | live]
(push) ; 9
; [then-branch: 19 | 0 <= First:(Second:($t@40@07))[i@41@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@40@07)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 19 | !(0 <= First:(Second:($t@40@07))[i@41@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 17 | !(i@41@07 < |First:(Second:($t@40@07))| && 0 <= i@41@07)]
(assert (not
  (and
    (<
      i@41@07
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))
  $Snap.unit))
...
;  :rlimit-count            126425)
(push) ; 3
; [then-branch: 20 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 | live]
; [else-branch: 20 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] != 0 | live]
(push) ; 4
; [then-branch: 20 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
    0)
...
(pop) ; 4
(push) ; 4
; [else-branch: 20 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
;  :quant-instantiations    38
;  :rlimit-count            127889)
; [then-branch: 21 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1 | live]
; [else-branch: 21 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1) | live]
(push) ; 4
; [then-branch: 21 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1]
(assert (or
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 21 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1)]
(assert (not
  (or
    (=
      (Seq_index
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))))
  $Snap.unit))
...
;  :rlimit-count            128543)
(push) ; 3
; [then-branch: 22 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 | live]
; [else-branch: 22 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] != 0 | live]
(push) ; 4
; [then-branch: 22 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
    1)
...
(pop) ; 4
(push) ; 4
; [else-branch: 22 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
;  :quant-instantiations    38
;  :rlimit-count            130075)
; [then-branch: 23 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1 | live]
; [else-branch: 23 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1) | live]
(push) ; 4
; [then-branch: 23 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1]
(assert (or
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 23 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1)]
(assert (not
  (or
    (=
      (Seq_index
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@40@07))))))))))
  $Snap.unit))
...
;  :rlimit-count            130735)
(push) ; 3
; [then-branch: 24 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 | live]
; [else-branch: 24 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] != 0 | live]
(push) ; 4
; [then-branch: 24 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
    0)
...
(pop) ; 4
(push) ; 4
; [else-branch: 24 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
;  :rlimit-count            132314
;  :time                    0.00)
; [then-branch: 25 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1) | live]
; [else-branch: 25 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1 | live]
(push) ; 4
; [then-branch: 25 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1)]
(assert (not
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 25 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[0] == -1]
(assert (or
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
;  :rlimit-count            132872)
(push) ; 3
; [then-branch: 26 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 | live]
; [else-branch: 26 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] != 0 | live]
(push) ; 4
; [then-branch: 26 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
    1)
...
(pop) ; 4
(push) ; 4
; [else-branch: 26 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))
...
;  :quant-instantiations    38
;  :rlimit-count            134452)
; [then-branch: 27 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1) | live]
; [else-branch: 27 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1 | live]
(push) ; 4
; [then-branch: 27 | !(First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1)]
(assert (not
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 27 | First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == 0 || First:(Second:(Second:(Second:(Second:($t@38@07)))))[1] == -1]
(assert (or
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@38@07))))))

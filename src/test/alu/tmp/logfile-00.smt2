...
; ---------- Monitor_joinToken_EncodedGlobalVariables ----------
(declare-const diz@18@00 $Ref)
(declare-const globals@19@00 $Ref)
; ---------- Monitor_idleToken_EncodedGlobalVariables ----------
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 10 | 0 <= i@27@00 | live]
; [else-branch: 10 | !(0 <= i@27@00) | live]
(push) ; 4
; [then-branch: 10 | 0 <= i@27@00]
(assert (<= 0 i@27@00))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(0 <= i@27@00)]
...
; Joined path conditions
(push) ; 3
; [then-branch: 11 | i@27@00 < |First:(Second:(Second:(Second:($t@26@00))))| && 0 <= i@27@00 | live]
; [else-branch: 11 | !(i@27@00 < |First:(Second:(Second:(Second:($t@26@00))))| && 0 <= i@27@00) | live]
(push) ; 4
; [then-branch: 11 | i@27@00 < |First:(Second:(Second:(Second:($t@26@00))))| && 0 <= i@27@00]
(assert (and
  (<
    i@27@00
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 12 | First:(Second:(Second:(Second:($t@26@00))))[i@27@00] == -1 | live]
; [else-branch: 12 | First:(Second:(Second:(Second:($t@26@00))))[i@27@00] != -1 | live]
(push) ; 6
; [then-branch: 12 | First:(Second:(Second:(Second:($t@26@00))))[i@27@00] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@26@00)))))
    i@27@00)
...
(pop) ; 6
(push) ; 6
; [else-branch: 12 | First:(Second:(Second:(Second:($t@26@00))))[i@27@00] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@26@00)))))
...
;  :rlimit-count            117451)
(push) ; 7
; [then-branch: 13 | 0 <= First:(Second:(Second:(Second:($t@26@00))))[i@27@00] | live]
; [else-branch: 13 | !(0 <= First:(Second:(Second:(Second:($t@26@00))))[i@27@00]) | live]
(push) ; 8
; [then-branch: 13 | 0 <= First:(Second:(Second:(Second:($t@26@00))))[i@27@00]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@26@00)))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 13 | !(0 <= First:(Second:(Second:(Second:($t@26@00))))[i@27@00])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | !(i@27@00 < |First:(Second:(Second:(Second:($t@26@00))))| && 0 <= i@27@00)]
(assert (not
  (and
    (<
      i@27@00
...
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@26@00))))))))))
    $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@26@00))))))))))
  ($Snap.combine
...
(assert (<=
  0
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@26@00)))))))))))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@26@00)))))))))))))))))
  ($Snap.combine
...
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@26@00))))))))))))))))))))
    $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@26@00))))))))))))))))))))
  ($Snap.combine
...
(assert ($Perm.isReadVar $k@31@00 $Perm.Write))
(set-option :timeout 0)
(push) ; 2
(assert (not (or (= $k@31@00 $Perm.No) (< $Perm.No $k@31@00))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s

...
; ------------------------------------------------------------
; ---------- Half_adder___contract_unsatisfiable__run_EncodedGlobalVariables ----------
...
(push) ; 2
; [exec]
; inhale true && (acc(diz.Half_adder_m, 1 / 2) && diz.Half_adder_m != null && acc(diz.Half_adder_m.Main_half, wildcard) && diz.Half_adder_m.Main_half == diz && acc(diz.Half_adder_init, 1 / 2) && !diz.Half_adder_init)
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@04)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04)))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@12@04 | live]
; [else-branch: 0 | !(0 <= i@12@04) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@12@04]
(assert (<= 0 i@12@04))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@12@04)]
(assert (not (<= 0 i@12@04)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@12@04 < |First:(Second:(Second:($t@11@04)))| && 0 <= i@12@04 | live]
; [else-branch: 1 | !(i@12@04 < |First:(Second:(Second:($t@11@04)))| && 0 <= i@12@04) | live]
(push) ; 4
; [then-branch: 1 | i@12@04 < |First:(Second:(Second:($t@11@04)))| && 0 <= i@12@04]
(assert (and
  (<
    i@12@04
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@11@04)))[i@12@04] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@11@04)))[i@12@04] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@11@04)))[i@12@04] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@04))))
    i@12@04)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@11@04)))[i@12@04] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@04))))
...
;  :rlimit-count            98882)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@11@04)))[i@12@04] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@11@04)))[i@12@04]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@11@04)))[i@12@04]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@04))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@11@04)))[i@12@04])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@12@04 < |First:(Second:(Second:($t@11@04)))| && 0 <= i@12@04)]
(assert (not
  (and
    (<
      i@12@04
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@04))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@04)))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@04))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@04)))))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@14@04 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@14@04 | live]
; [else-branch: 4 | !(0 <= i@14@04) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@14@04]
(assert (<= 0 i@14@04))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@14@04)]
(assert (not (<= 0 i@14@04)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@14@04 < |First:(Second:($t@13@04))| && 0 <= i@14@04 | live]
; [else-branch: 5 | !(i@14@04 < |First:(Second:($t@13@04))| && 0 <= i@14@04) | live]
(push) ; 5
; [then-branch: 5 | i@14@04 < |First:(Second:($t@13@04))| && 0 <= i@14@04]
(assert (and
  (<
    i@14@04
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@13@04))[i@14@04] == -1 | live]
; [else-branch: 6 | First:(Second:($t@13@04))[i@14@04] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@13@04))[i@14@04] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@04)))
    i@14@04)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@13@04))[i@14@04] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@04)))
...
;  :rlimit-count            100906)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@13@04))[i@14@04] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@13@04))[i@14@04]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@13@04))[i@14@04]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@04)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@13@04))[i@14@04])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@14@04 < |First:(Second:($t@13@04))| && 0 <= i@14@04)]
(assert (not
  (and
    (<
      i@14@04
...
;  :rlimit-count            102070)
(push) ; 3
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@11@04)))[0] | live]
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@11@04)))[0]) | live]
(push) ; 4
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@11@04)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@04))))
...
;  :rlimit-count            102350)
(push) ; 5
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 | live]
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] != 0 | live]
(push) ; 6
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@11@04)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            104077
;  :time                    0.00)
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0] | live]
; [else-branch: 10 | !(First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0]) | live]
(push) ; 4
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0]]
(assert (and
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0])]
(assert (not
  (and
    (or
      (=
...
;  :rlimit-count            104740)
(push) ; 3
; [then-branch: 11 | 0 <= First:(Second:(Second:($t@11@04)))[0] | live]
; [else-branch: 11 | !(0 <= First:(Second:(Second:($t@11@04)))[0]) | live]
(push) ; 4
; [then-branch: 11 | 0 <= First:(Second:(Second:($t@11@04)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@04))))
...
;  :rlimit-count            104974)
(push) ; 5
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 | live]
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] != 0 | live]
(push) ; 6
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@04))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | !(0 <= First:(Second:(Second:($t@11@04)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            106743
;  :time                    0.00)
; [then-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0]) | live]
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0] | live]
(push) ; 4
; [then-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0])]
(assert (not
  (and
    (or
      (=
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@11@04)))))[First:(Second:(Second:($t@11@04)))[0]] == -1 && 0 <= First:(Second:(Second:($t@11@04)))[0]]
(assert (and
  (or
    (=
      (Seq_index

...
; ------------------------------------------------------------
; ---------- Half_adder_forkOperator_EncodedGlobalVariables ----------
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))))))
(set-option :timeout 0)
(push) ; 2
(assert (not (not (= 2 0))))
(check-sat)
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))))
  $Snap.unit))
; [eval] !diz.Half_adder_init
(assert (not
  ($SortWrappers.$SnapToBool ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))))))
...
(declare-const diz@9@06 $Ref)
(declare-const globals@10@06 $Ref)
(push) ; 1
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@06)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06)))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@12@06 | live]
; [else-branch: 0 | !(0 <= i@12@06) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@12@06]
(assert (<= 0 i@12@06))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@12@06)]
(assert (not (<= 0 i@12@06)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@12@06 < |First:(Second:(Second:($t@11@06)))| && 0 <= i@12@06 | live]
; [else-branch: 1 | !(i@12@06 < |First:(Second:(Second:($t@11@06)))| && 0 <= i@12@06) | live]
(push) ; 4
; [then-branch: 1 | i@12@06 < |First:(Second:(Second:($t@11@06)))| && 0 <= i@12@06]
(assert (and
  (<
    i@12@06
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@11@06)))[i@12@06] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@11@06)))[i@12@06] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@11@06)))[i@12@06] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@06))))
    i@12@06)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@11@06)))[i@12@06] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@06))))
...
;  :rlimit-count            97920)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@11@06)))[i@12@06] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@11@06)))[i@12@06]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@11@06)))[i@12@06]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@06))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@11@06)))[i@12@06])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@12@06 < |First:(Second:(Second:($t@11@06)))| && 0 <= i@12@06)]
(assert (not
  (and
    (<
      i@12@06
...
(assert (=
  ($Snap.second ($Snap.second $t@13@06))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@13@06)))
    ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@13@06))) $Snap.unit))
; [eval] |diz.Main_process_state| == 1
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@06))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@06)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@06))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))
  $Snap.unit))
; [eval] |diz.Main_event_state| == 2
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@14@06 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@14@06 | live]
; [else-branch: 4 | !(0 <= i@14@06) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@14@06]
(assert (<= 0 i@14@06))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@14@06)]
(assert (not (<= 0 i@14@06)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@14@06 < |First:(Second:($t@13@06))| && 0 <= i@14@06 | live]
; [else-branch: 5 | !(i@14@06 < |First:(Second:($t@13@06))| && 0 <= i@14@06) | live]
(push) ; 5
; [then-branch: 5 | i@14@06 < |First:(Second:($t@13@06))| && 0 <= i@14@06]
(assert (and
  (<
    i@14@06
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@13@06))[i@14@06] == -1 | live]
; [else-branch: 6 | First:(Second:($t@13@06))[i@14@06] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@13@06))[i@14@06] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@06)))
    i@14@06)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@13@06))[i@14@06] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@06)))
...
;  :rlimit-count            99944)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@13@06))[i@14@06] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@13@06))[i@14@06]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@13@06))[i@14@06]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@06)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@13@06))[i@14@06])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@14@06 < |First:(Second:($t@13@06))| && 0 <= i@14@06)]
(assert (not
  (and
    (<
      i@14@06
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))
  $Snap.unit))
...
;  :quant-instantiations    17
;  :rlimit-count            102205)
; [then-branch: 8 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] == 0 | live]
; [else-branch: 8 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] != 0 | live]
(push) ; 4
; [then-branch: 8 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
    0)
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))))
  $Snap.unit))
...
;  :rlimit-count            103975
;  :time                    0.00)
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] == 0 | live]
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] != 0 | live]
(push) ; 4
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
    1)
...
(pop) ; 4
(push) ; 4
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@06))))))))))
  $Snap.unit))
...
;  :rlimit-count            105798
;  :time                    0.00)
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] != 0 | live]
; [else-branch: 10 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] == 0 | live]
(push) ; 4
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
    0)
...
;  :rlimit-count            107510
;  :time                    0.00)
; [then-branch: 11 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] != 0 | live]
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] == 0 | live]
(push) ; 4
; [then-branch: 11 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@11@06)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@06))))))
    1)

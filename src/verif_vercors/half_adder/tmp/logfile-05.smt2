...
; ------------------------------------------------------------
; ---------- Half_adder_joinOperator_EncodedGlobalVariables ----------
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05)))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05)))))))))
(set-option :timeout 0)
(push) ; 3
(assert (not (not (= 2 0))))
(check-sat)
...
(assert (not
  ($SortWrappers.$SnapToBool ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@5@05)))))))))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
...
(assert (= $t@11@05 ($Snap.combine ($Snap.first $t@11@05) ($Snap.second $t@11@05))))
(assert (= ($Snap.first $t@11@05) $Snap.unit))
; [eval] diz != null
(assert (not (= diz@9@05 $Ref.null)))
(assert (=
  ($Snap.second $t@11@05)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@11@05))
    ($Snap.second ($Snap.second $t@11@05)))))
(assert (=
  ($Snap.second ($Snap.second $t@11@05))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@11@05)))
    ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@11@05)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@11@05))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@11@05))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@05)))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05)))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))
  $Snap.unit))
...
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@12@05 < |First:(Second:(Second:($t@11@05)))| && 0 <= i@12@05 | live]
; [else-branch: 1 | !(i@12@05 < |First:(Second:(Second:($t@11@05)))| && 0 <= i@12@05) | live]
(push) ; 4
; [then-branch: 1 | i@12@05 < |First:(Second:(Second:($t@11@05)))| && 0 <= i@12@05]
(assert (and
  (<
    i@12@05
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@11@05)))[i@12@05] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@11@05)))[i@12@05] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@11@05)))[i@12@05] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@05))))
    i@12@05)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@11@05)))[i@12@05] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@05))))
...
;  :rlimit-count            97657)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@11@05)))[i@12@05] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@11@05)))[i@12@05]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@11@05)))[i@12@05]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@05))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@11@05)))[i@12@05])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@12@05 < |First:(Second:(Second:($t@11@05)))| && 0 <= i@12@05)]
(assert (not
  (and
    (<
      i@12@05
...
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@13@05))) $Snap.unit))
; [eval] |diz.Main_process_state| == 1
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@05))))
  1))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@05)))
  ($Snap.combine
...
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@14@05 < |First:(Second:($t@13@05))| && 0 <= i@14@05 | live]
; [else-branch: 5 | !(i@14@05 < |First:(Second:($t@13@05))| && 0 <= i@14@05) | live]
(push) ; 5
; [then-branch: 5 | i@14@05 < |First:(Second:($t@13@05))| && 0 <= i@14@05]
(assert (and
  (<
    i@14@05
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@13@05))[i@14@05] == -1 | live]
; [else-branch: 6 | First:(Second:($t@13@05))[i@14@05] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@13@05))[i@14@05] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@05)))
    i@14@05)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@13@05))[i@14@05] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@05)))
...
;  :rlimit-count            99681)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@13@05))[i@14@05] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@13@05))[i@14@05]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@13@05))[i@14@05]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@13@05)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@13@05))[i@14@05])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@14@05 < |First:(Second:($t@13@05))| && 0 <= i@14@05)]
(assert (not
  (and
    (<
      i@14@05
...
;  :rlimit-count            100845)
(push) ; 3
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@11@05)))[0] | live]
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@11@05)))[0]) | live]
(push) ; 4
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@11@05)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@05))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@11@05)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            102530
;  :time                    0.00)
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0] | live]
; [else-branch: 9 | !(First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0]) | live]
(push) ; 4
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 9 | !(First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0])]
(assert (not
  (and
    (=
      (Seq_index
...
;  :rlimit-count            103131)
(push) ; 3
; [then-branch: 10 | 0 <= First:(Second:(Second:($t@11@05)))[0] | live]
; [else-branch: 10 | !(0 <= First:(Second:(Second:($t@11@05)))[0]) | live]
(push) ; 4
; [then-branch: 10 | 0 <= First:(Second:(Second:($t@11@05)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@11@05))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(0 <= First:(Second:(Second:($t@11@05)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            104887
;  :time                    0.00)
; [then-branch: 11 | !(First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0]) | live]
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0] | live]
(push) ; 4
; [then-branch: 11 | !(First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0])]
(assert (not
  (and
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@11@05)))))[First:(Second:(Second:($t@11@05)))[0]] == 0 && 0 <= First:(Second:(Second:($t@11@05)))[0]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@11@05))))))

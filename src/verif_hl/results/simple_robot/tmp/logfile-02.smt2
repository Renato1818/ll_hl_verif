...
(push) ; 2
; [exec]
; var min_advance__17: Int
(declare-const min_advance__17@11@02 Int)
; [exec]
; var __flatten_19__15: Seq[Int]
(declare-const __flatten_19__15@12@02 Seq<Int>)
; [exec]
; var __flatten_20__16: Seq[Int]
(declare-const __flatten_20__16@13@02 Seq<Int>)
; [exec]
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))))
  ($Snap.combine
...
; [eval] 0 <= i
(push) ; 4
; [then-branch: 0 | 0 <= i@15@02 | live]
; [else-branch: 0 | !(0 <= i@15@02) | live]
(push) ; 5
; [then-branch: 0 | 0 <= i@15@02]
(assert (<= 0 i@15@02))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 0 | !(0 <= i@15@02)]
(assert (not (<= 0 i@15@02)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 1 | i@15@02 < |First:(Second:(Second:(Second:($t@14@02))))| && 0 <= i@15@02 | live]
; [else-branch: 1 | !(i@15@02 < |First:(Second:(Second:(Second:($t@14@02))))| && 0 <= i@15@02) | live]
(push) ; 5
; [then-branch: 1 | i@15@02 < |First:(Second:(Second:(Second:($t@14@02))))| && 0 <= i@15@02]
(assert (and
  (<
    i@15@02
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:(Second:($t@14@02))))[i@15@02] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:(Second:($t@14@02))))[i@15@02] != -1 | live]
(push) ; 7
; [then-branch: 2 | First:(Second:(Second:(Second:($t@14@02))))[i@15@02] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))
    i@15@02)
...
(pop) ; 7
(push) ; 7
; [else-branch: 2 | First:(Second:(Second:(Second:($t@14@02))))[i@15@02] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))
...
;  :rlimit-count          113853)
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:(Second:($t@14@02))))[i@15@02] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:(Second:($t@14@02))))[i@15@02]) | live]
(push) ; 9
; [then-branch: 3 | 0 <= First:(Second:(Second:(Second:($t@14@02))))[i@15@02]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))
...
(pop) ; 9
(push) ; 9
; [else-branch: 3 | !(0 <= First:(Second:(Second:(Second:($t@14@02))))[i@15@02])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(i@15@02 < |First:(Second:(Second:(Second:($t@14@02))))| && 0 <= i@15@02)]
(assert (not
  (and
    (<
      i@15@02
...
(assert (implies (< $Perm.No $k@16@02) (not (= diz@8@02 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))))))
  ($Snap.combine
...
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))))
    $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))))
  ($Snap.combine
...
(declare-const $k@17@02 $Perm)
(assert ($Perm.isReadVar $k@17@02 $Perm.Write))
(set-option :timeout 0)
(push) ; 3
(assert (not (or (= $k@17@02 $Perm.No) (< $Perm.No $k@17@02))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
...
;  :rlimit-count          115569)
(assert (<= $Perm.No $k@17@02))
(assert (<= $k@17@02 $Perm.Write))
(assert (implies (< $Perm.No $k@17@02) (not (= diz@8@02 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))))))))
  ($Snap.combine
...
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))))))
    $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))))))
  ($Snap.combine
...
(assert (implies (< $Perm.No $k@18@02) (not (= diz@8@02 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))))))))
  ($Snap.combine
...
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))))))))))))
    $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))))))))))))
  ($Snap.combine
...
;  :rlimit-count          118355)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))))))))))))))
  diz@8@02))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (Main_lock_invariant_EncodedGlobalVariables%trigger $t@14@02 diz@8@02 globals@9@02))
; [exec]
...
; unknown
; [exec]
; Sensor_forkOperator_EncodedGlobalVariables(diz.Main_robot_sensor, globals)
(set-option :timeout 10)
(push) ; 3
(assert (not (< $Perm.No $k@17@02)))
(check-sat)
...
(declare-const diz@23@02 $Ref)
(declare-const globals@24@02 $Ref)
(declare-const diz@25@02 $Ref)
(declare-const globals@26@02 $Ref)
(push) ; 1
(declare-const $t@27@02 $Snap)
(assert (= $t@27@02 $Snap.unit))
; [eval] diz != null
(assert (not (= diz@25@02 $Ref.null)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
(push) ; 2
; [exec]
; inhale true && (acc(diz.Sensor_m, wildcard) && diz.Sensor_m != null && acc(diz.Sensor_m.Main_robot_sensor, wildcard) && diz.Sensor_m.Main_robot_sensor == diz)
(declare-const $t@28@02 $Snap)
(assert (= $t@28@02 ($Snap.combine ($Snap.first $t@28@02) ($Snap.second $t@28@02))))
(assert (= ($Snap.first $t@28@02) $Snap.unit))
(assert (=
  ($Snap.second $t@28@02)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@28@02))
    ($Snap.second ($Snap.second $t@28@02)))))
...
(assert (implies (< $Perm.No $k@29@02) (not (= diz@25@02 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second $t@28@02))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@28@02)))
    ($Snap.second ($Snap.second ($Snap.second $t@28@02))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@28@02))) $Snap.unit))
...
;  :rlimit-count            124197)
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@28@02))) $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@28@02)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@28@02))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@28@02)))))))
(push) ; 3
(assert (not (< $Perm.No $k@29@02)))
(check-sat)
; unsat
...
(assert (implies
  ...
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@28@02)))
      $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@28@02))))
  $Snap.unit))
...
;  :rlimit-count            124914)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@28@02)))))
  diz@25@02))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)

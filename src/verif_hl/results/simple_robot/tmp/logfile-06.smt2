...
; [eval] diz != null
(assert (not (= diz@2@06 $Ref.null)))
(assert (=
  ($Snap.second $t@4@06)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@4@06))
    ($Snap.second ($Snap.second $t@4@06)))))
(declare-const $k@5@06 $Perm)
(assert ($Perm.isReadVar $k@5@06 $Perm.Write))
(set-option :timeout 0)
(push) ; 2
(assert (not (or (= $k@5@06 $Perm.No) (< $Perm.No $k@5@06))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
;  :rlimit-count         110666)
(assert (<= $Perm.No $k@5@06))
(assert (<= $k@5@06 $Perm.Write))
(assert (implies (< $Perm.No $k@5@06) (not (= diz@2@06 $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second $t@4@06))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@4@06)))
    ($Snap.second ($Snap.second ($Snap.second $t@4@06))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@4@06))) $Snap.unit))
; [eval] diz.Controller_m != null
(set-option :timeout 10)
(push) ; 2
(assert (not (< $Perm.No $k@5@06)))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
;  :rlimit-count         110919)
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@4@06))) $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@4@06)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@4@06))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))))
(push) ; 2
(assert (not (< $Perm.No $k@5@06)))
(check-sat)
; unsat
...
;  :rlimit-count         111203)
(declare-const $k@6@06 $Perm)
(assert ($Perm.isReadVar $k@6@06 $Perm.Write))
(set-option :timeout 0)
(push) ; 2
(assert (not (or (= $k@6@06 $Perm.No) (< $Perm.No $k@6@06))))
(check-sat)
; unsat
(pop) ; 2
; 0.00s
...
;  :quant-instantiations 2
;  :rlimit-count         111402)
(assert (<= $Perm.No $k@6@06))
(assert (<= $k@6@06 $Perm.Write))
(assert (implies
  (< $Perm.No $k@6@06)
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second $t@4@06)))
      $Ref.null))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))
  $Snap.unit))
...
;  :rlimit-count         111723)
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@4@06)))))
  diz@2@06))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06)))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06)))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@13@06 | live]
; [else-branch: 0 | !(0 <= i@13@06) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@13@06]
(assert (<= 0 i@13@06))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@13@06)]
(assert (not (<= 0 i@13@06)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@13@06 < |First:(Second:(Second:($t@12@06)))| && 0 <= i@13@06 | live]
; [else-branch: 1 | !(i@13@06 < |First:(Second:(Second:($t@12@06)))| && 0 <= i@13@06) | live]
(push) ; 4
; [then-branch: 1 | i@13@06 < |First:(Second:(Second:($t@12@06)))| && 0 <= i@13@06]
(assert (and
  (<
    i@13@06
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@12@06)))[i@13@06] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@12@06)))[i@13@06] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@12@06)))[i@13@06] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
    i@13@06)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@12@06)))[i@13@06] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
...
;  :rlimit-count            113512)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@12@06)))[i@13@06] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@12@06)))[i@13@06]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@12@06)))[i@13@06]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@12@06)))[i@13@06])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@13@06 < |First:(Second:(Second:($t@12@06)))| && 0 <= i@13@06)]
(assert (not
  (and
    (<
      i@13@06
...
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@14@06))) $Snap.unit))
; [eval] |diz.Main_process_state| == 2
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@14@06))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@14@06)))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06)))))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@15@06 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@15@06 | live]
; [else-branch: 4 | !(0 <= i@15@06) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@15@06]
(assert (<= 0 i@15@06))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@15@06)]
(assert (not (<= 0 i@15@06)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@15@06 < |First:(Second:($t@14@06))| && 0 <= i@15@06 | live]
; [else-branch: 5 | !(i@15@06 < |First:(Second:($t@14@06))| && 0 <= i@15@06) | live]
(push) ; 5
; [then-branch: 5 | i@15@06 < |First:(Second:($t@14@06))| && 0 <= i@15@06]
(assert (and
  (<
    i@15@06
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@14@06))[i@15@06] == -1 | live]
; [else-branch: 6 | First:(Second:($t@14@06))[i@15@06] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@14@06))[i@15@06] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@14@06)))
    i@15@06)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@14@06))[i@15@06] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@14@06)))
...
;  :rlimit-count            115569)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@14@06))[i@15@06] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@14@06))[i@15@06]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@14@06))[i@15@06]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@14@06)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@14@06))[i@15@06])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@15@06 < |First:(Second:($t@14@06))| && 0 <= i@15@06)]
(assert (not
  (and
    (<
      i@15@06
...
;  :rlimit-count            116734)
(push) ; 3
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@12@06)))[0] | live]
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@12@06)))[0]) | live]
(push) ; 4
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@12@06)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
...
;  :rlimit-count            117012)
(push) ; 5
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 | live]
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] != 0 | live]
(push) ; 6
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@12@06)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            118810
;  :time                    0.00)
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0] | live]
; [else-branch: 10 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0]) | live]
(push) ; 4
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0]]
(assert (and
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0])]
(assert (not
  (and
    (or
      (=
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06)))))))))
  $Snap.unit))
...
;  :rlimit-count            119574)
(push) ; 3
; [then-branch: 11 | 0 <= First:(Second:(Second:($t@12@06)))[1] | live]
; [else-branch: 11 | !(0 <= First:(Second:(Second:($t@12@06)))[1]) | live]
(push) ; 4
; [then-branch: 11 | 0 <= First:(Second:(Second:($t@12@06)))[1]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
...
;  :rlimit-count            119854)
(push) ; 5
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 | live]
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] != 0 | live]
(push) ; 6
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | !(0 <= First:(Second:(Second:($t@12@06)))[1])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            121892
;  :time                    0.00)
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1] | live]
; [else-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1]) | live]
(push) ; 4
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1]]
(assert (and
  (or
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1])]
(assert (not
  (and
    (or
      (=
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))))
  $Snap.unit))
...
;  :rlimit-count            122665)
(push) ; 3
; [then-branch: 14 | 0 <= First:(Second:(Second:($t@12@06)))[0] | live]
; [else-branch: 14 | !(0 <= First:(Second:(Second:($t@12@06)))[0]) | live]
(push) ; 4
; [then-branch: 14 | 0 <= First:(Second:(Second:($t@12@06)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
...
;  :rlimit-count            122899)
(push) ; 5
; [then-branch: 15 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 | live]
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] != 0 | live]
(push) ; 6
; [then-branch: 15 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 14 | !(0 <= First:(Second:(Second:($t@12@06)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            124888
;  :time                    0.00)
; [then-branch: 16 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0]) | live]
; [else-branch: 16 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0] | live]
(push) ; 4
; [then-branch: 16 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0])]
(assert (not
  (and
    (or
      (=
...
(pop) ; 4
(push) ; 4
; [else-branch: 16 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[0]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[0]]
(assert (and
  (or
    (=
      (Seq_index
...
;  :rlimit-count            125561)
(push) ; 3
; [then-branch: 17 | 0 <= First:(Second:(Second:($t@12@06)))[1] | live]
; [else-branch: 17 | !(0 <= First:(Second:(Second:($t@12@06)))[1]) | live]
(push) ; 4
; [then-branch: 17 | 0 <= First:(Second:(Second:($t@12@06)))[1]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@12@06))))
...
;  :rlimit-count            125795)
(push) ; 5
; [then-branch: 18 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 | live]
; [else-branch: 18 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] != 0 | live]
(push) ; 6
; [then-branch: 18 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
    (Seq_index
...
(pop) ; 6
(push) ; 6
; [else-branch: 18 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@06))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 17 | !(0 <= First:(Second:(Second:($t@12@06)))[1])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            127854
;  :time                    0.00)
; [then-branch: 19 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1]) | live]
; [else-branch: 19 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1] | live]
(push) ; 4
; [then-branch: 19 | !(First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1])]
(assert (not
  (and
    (or
      (=
...
(pop) ; 4
(push) ; 4
; [else-branch: 19 | First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == 0 || First:(Second:(Second:(Second:(Second:($t@12@06)))))[First:(Second:(Second:($t@12@06)))[1]] == -1 && 0 <= First:(Second:(Second:($t@12@06)))[1]]
(assert (and
  (or
    (=
      (Seq_index

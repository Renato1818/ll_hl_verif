...
(assert (= (type_of<TYPE> sys__result@5@07) (as class_Controller<TYPE>  TYPE)))
(assert (=
  ($Snap.second ($Snap.second $t@6@07))
  ($Snap.combine
...
; [exec]
; diz__1 := new(Controller_m, Controller_alarm_flag)
(declare-const diz__1@8@07 $Ref)
(assert (not (= diz__1@8@07 $Ref.null)))
(declare-const Controller_m@9@07 $Ref)
(declare-const Controller_alarm_flag@10@07 Bool)
...
; [exec]
; inhale type_of(diz__1) == class_Controller()
(declare-const $t@11@07 $Snap)
(assert (= $t@11@07 $Snap.unit))
; [eval] type_of(diz__1) == class_Controller()
; [eval] type_of(diz__1)
; [eval] class_Controller()
(assert (= (type_of<TYPE> diz__1@8@07) (as class_Controller<TYPE>  TYPE)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; diz__1.Controller_m := m_param
; [exec]
; inhale acc(Controller_idleToken_EncodedGlobalVariables(diz__1, globals), write)
...
; [exec]
; // assert
; assert sys__result != null && type_of(sys__result) == class_Controller() && acc(Controller_idleToken_EncodedGlobalVariables(sys__result, globals), write) && acc(sys__result.Controller_m, write) && acc(sys__result.Controller_alarm_flag, write) && sys__result.Controller_m == m_param
; [eval] sys__result != null
; [eval] type_of(sys__result) == class_Controller()
; [eval] type_of(sys__result)
; [eval] class_Controller()
...
(declare-const diz@13@07 $Ref)
(declare-const globals@14@07 $Ref)
(declare-const diz@15@07 $Ref)
(declare-const globals@16@07 $Ref)
(push) ; 1
(declare-const $t@17@07 $Snap)
(assert (= $t@17@07 ($Snap.combine ($Snap.first $t@17@07) ($Snap.second $t@17@07))))
(assert (= ($Snap.first $t@17@07) $Snap.unit))
; [eval] diz != null
(assert (not (= diz@15@07 $Ref.null)))
(assert (=
  ($Snap.second $t@17@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@17@07))
    ($Snap.second ($Snap.second $t@17@07)))))
(assert (=
  ($Snap.second ($Snap.second $t@17@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@17@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@17@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@17@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@17@07))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@17@07)))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
  $Snap.unit))
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07)))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@18@07 | live]
; [else-branch: 0 | !(0 <= i@18@07) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@18@07]
(assert (<= 0 i@18@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@18@07)]
(assert (not (<= 0 i@18@07)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@18@07 < |First:(Second:(Second:($t@17@07)))| && 0 <= i@18@07 | live]
; [else-branch: 1 | !(i@18@07 < |First:(Second:(Second:($t@17@07)))| && 0 <= i@18@07) | live]
(push) ; 4
; [then-branch: 1 | i@18@07 < |First:(Second:(Second:($t@17@07)))| && 0 <= i@18@07]
(assert (and
  (<
    i@18@07
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@17@07)))[i@18@07] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@17@07)))[i@18@07] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@17@07)))[i@18@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@17@07))))
    i@18@07)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@17@07)))[i@18@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@17@07))))
...
;  :rlimit-count          112696)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@17@07)))[i@18@07] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@17@07)))[i@18@07]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@17@07)))[i@18@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@17@07))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@17@07)))[i@18@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@18@07 < |First:(Second:(Second:($t@17@07)))| && 0 <= i@18@07)]
(assert (not
  (and
    (<
      i@18@07
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@19@07))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@19@07)))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@20@07 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@20@07 | live]
; [else-branch: 4 | !(0 <= i@20@07) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@20@07]
(assert (<= 0 i@20@07))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@20@07)]
(assert (not (<= 0 i@20@07)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@20@07 < |First:(Second:($t@19@07))| && 0 <= i@20@07 | live]
; [else-branch: 5 | !(i@20@07 < |First:(Second:($t@19@07))| && 0 <= i@20@07) | live]
(push) ; 5
; [then-branch: 5 | i@20@07 < |First:(Second:($t@19@07))| && 0 <= i@20@07]
(assert (and
  (<
    i@20@07
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@19@07))[i@20@07] == -1 | live]
; [else-branch: 6 | First:(Second:($t@19@07))[i@20@07] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@19@07))[i@20@07] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@19@07)))
    i@20@07)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@19@07))[i@20@07] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@19@07)))
...
;  :rlimit-count            114753)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@19@07))[i@20@07] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@19@07))[i@20@07]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@19@07))[i@20@07]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@19@07)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@19@07))[i@20@07])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@20@07 < |First:(Second:($t@19@07))| && 0 <= i@20@07)]
(assert (not
  (and
    (<
      i@20@07
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))
  $Snap.unit))
...
;  :rlimit-count            117087
;  :time                    0.00)
; [then-branch: 8 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] == 0 | live]
; [else-branch: 8 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] != 0 | live]
(push) ; 4
; [then-branch: 8 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    0)
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))
  $Snap.unit))
...
;  :rlimit-count            118929
;  :time                    0.00)
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] == 0 | live]
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] != 0 | live]
(push) ; 4
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    1)
...
(pop) ; 4
(push) ; 4
; [else-branch: 9 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))
  $Snap.unit))
...
;  :rlimit-count            120837
;  :time                    0.00)
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] == 0 | live]
; [else-branch: 10 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] != 0 | live]
(push) ; 4
; [then-branch: 10 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    2)
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))))
  $Snap.unit))
...
;  :rlimit-count            122801
;  :time                    0.00)
; [then-branch: 11 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] != 0 | live]
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] == 0 | live]
(push) ; 4
; [then-branch: 11 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[0] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    0)
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07)))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@07))))))))))))
  $Snap.unit))
...
;  :rlimit-count            124774
;  :time                    0.00)
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] != 0 | live]
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] == 0 | live]
(push) ; 4
; [then-branch: 12 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 12 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[1] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    1)
...
;  :rlimit-count            126658
;  :time                    0.00)
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] != 0 | live]
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] == 0 | live]
(push) ; 4
; [then-branch: 13 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] != 0]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@17@07)))))[2] == 0]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@07))))))
    2)

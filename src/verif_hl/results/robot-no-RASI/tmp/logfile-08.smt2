...
; ------------------------------------------------------------
; ---------- Sensor___contract_unsatisfiable__Sensor_EncodedGlobalVariables_Main ----------
(declare-const diz@0@08 $Ref)
(declare-const globals@1@08 $Ref)
(declare-const m0@2@08 $Ref)
(declare-const diz@3@08 $Ref)
(declare-const globals@4@08 $Ref)
(declare-const m0@5@08 $Ref)
(push) ; 1
...
(pop) ; 2
(pop) ; 1
; ---------- Controller_joinOperator_EncodedGlobalVariables ----------
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08)))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08))))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08)))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08))))))
  $Snap.unit))
...
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | 0 <= i@20@08 | live]
; [else-branch: 0 | !(0 <= i@20@08) | live]
(push) ; 4
; [then-branch: 0 | 0 <= i@20@08]
(assert (<= 0 i@20@08))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 4
(push) ; 4
; [else-branch: 0 | !(0 <= i@20@08)]
(assert (not (<= 0 i@20@08)))
(pop) ; 4
(pop) ; 3
; Joined path conditions
; Joined path conditions
(push) ; 3
; [then-branch: 1 | i@20@08 < |First:(Second:(Second:($t@19@08)))| && 0 <= i@20@08 | live]
; [else-branch: 1 | !(i@20@08 < |First:(Second:(Second:($t@19@08)))| && 0 <= i@20@08) | live]
(push) ; 4
; [then-branch: 1 | i@20@08 < |First:(Second:(Second:($t@19@08)))| && 0 <= i@20@08]
(assert (and
  (<
    i@20@08
    (Seq_length
...
; [eval] -1
(push) ; 5
; [then-branch: 2 | First:(Second:(Second:($t@19@08)))[i@20@08] == -1 | live]
; [else-branch: 2 | First:(Second:(Second:($t@19@08)))[i@20@08] != -1 | live]
(push) ; 6
; [then-branch: 2 | First:(Second:(Second:($t@19@08)))[i@20@08] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
    i@20@08)
...
(pop) ; 6
(push) ; 6
; [else-branch: 2 | First:(Second:(Second:($t@19@08)))[i@20@08] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
...
;  :rlimit-count            114463)
(push) ; 7
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@19@08)))[i@20@08] | live]
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@19@08)))[i@20@08]) | live]
(push) ; 8
; [then-branch: 3 | 0 <= First:(Second:(Second:($t@19@08)))[i@20@08]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
...
(pop) ; 8
(push) ; 8
; [else-branch: 3 | !(0 <= First:(Second:(Second:($t@19@08)))[i@20@08])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 1 | !(i@20@08 < |First:(Second:(Second:($t@19@08)))| && 0 <= i@20@08)]
(assert (not
  (and
    (<
      i@20@08
...
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@21@08))) $Snap.unit))
; [eval] |diz.Main_process_state| == 2
; [eval] |diz.Main_process_state|
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@21@08))))
  2))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@21@08)))
  ($Snap.combine
...
(assert (=
  (Seq_length
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))
  3))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] (forall i: Int :: { diz.Main_process_state[i] } 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|)
(declare-const i@22@08 Int)
(push) ; 3
; [eval] 0 <= i && i < |diz.Main_process_state| ==> diz.Main_process_state[i] == -1 || 0 <= diz.Main_process_state[i] && diz.Main_process_state[i] < |diz.Main_event_state|
; [eval] 0 <= i && i < |diz.Main_process_state|
; [eval] 0 <= i
(push) ; 4
; [then-branch: 4 | 0 <= i@22@08 | live]
; [else-branch: 4 | !(0 <= i@22@08) | live]
(push) ; 5
; [then-branch: 4 | 0 <= i@22@08]
(assert (<= 0 i@22@08))
; [eval] i < |diz.Main_process_state|
; [eval] |diz.Main_process_state|
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(0 <= i@22@08)]
(assert (not (<= 0 i@22@08)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(push) ; 4
; [then-branch: 5 | i@22@08 < |First:(Second:($t@21@08))| && 0 <= i@22@08 | live]
; [else-branch: 5 | !(i@22@08 < |First:(Second:($t@21@08))| && 0 <= i@22@08) | live]
(push) ; 5
; [then-branch: 5 | i@22@08 < |First:(Second:($t@21@08))| && 0 <= i@22@08]
(assert (and
  (<
    i@22@08
    (Seq_length
...
; [eval] -1
(push) ; 6
; [then-branch: 6 | First:(Second:($t@21@08))[i@22@08] == -1 | live]
; [else-branch: 6 | First:(Second:($t@21@08))[i@22@08] != -1 | live]
(push) ; 7
; [then-branch: 6 | First:(Second:($t@21@08))[i@22@08] == -1]
(assert (=
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@21@08)))
    i@22@08)
...
(pop) ; 7
(push) ; 7
; [else-branch: 6 | First:(Second:($t@21@08))[i@22@08] != -1]
(assert (not
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@21@08)))
...
;  :rlimit-count            116516)
(push) ; 8
; [then-branch: 7 | 0 <= First:(Second:($t@21@08))[i@22@08] | live]
; [else-branch: 7 | !(0 <= First:(Second:($t@21@08))[i@22@08]) | live]
(push) ; 9
; [then-branch: 7 | 0 <= First:(Second:($t@21@08))[i@22@08]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second $t@21@08)))
...
(pop) ; 9
(push) ; 9
; [else-branch: 7 | !(0 <= First:(Second:($t@21@08))[i@22@08])]
(assert (not
  (<=
    0
    (Seq_index
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(i@22@08 < |First:(Second:($t@21@08))| && 0 <= i@22@08)]
(assert (not
  (and
    (<
      i@22@08
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))
  $Snap.unit))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))
  $Snap.unit))
...
;  :rlimit-count            117680)
(push) ; 3
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@19@08)))[0] | live]
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@19@08)))[0]) | live]
(push) ; 4
; [then-branch: 8 | 0 <= First:(Second:(Second:($t@19@08)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 8 | !(0 <= First:(Second:(Second:($t@19@08)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            119457)
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0] | live]
; [else-branch: 9 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0]) | live]
(push) ; 4
; [then-branch: 9 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 9 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0])]
(assert (not
  (and
    (=
      (Seq_index
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))))
  $Snap.unit))
...
;  :rlimit-count            120153)
(push) ; 3
; [then-branch: 10 | 0 <= First:(Second:(Second:($t@19@08)))[1] | live]
; [else-branch: 10 | !(0 <= First:(Second:(Second:($t@19@08)))[1]) | live]
(push) ; 4
; [then-branch: 10 | 0 <= First:(Second:(Second:($t@19@08)))[1]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 10 | !(0 <= First:(Second:(Second:($t@19@08)))[1])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            122127
;  :time                    0.00)
; [then-branch: 11 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1] | live]
; [else-branch: 11 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1]) | live]
(push) ; 4
; [then-branch: 11 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 11 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1])]
(assert (not
  (and
    (=
      (Seq_index
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08)))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@21@08))))))))))
  $Snap.unit))
...
;  :rlimit-count            122833)
(push) ; 3
; [then-branch: 12 | 0 <= First:(Second:(Second:($t@19@08)))[0] | live]
; [else-branch: 12 | !(0 <= First:(Second:(Second:($t@19@08)))[0]) | live]
(push) ; 4
; [then-branch: 12 | 0 <= First:(Second:(Second:($t@19@08)))[0]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 12 | !(0 <= First:(Second:(Second:($t@19@08)))[0])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            124725
;  :time                    0.00)
; [then-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0]) | live]
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0] | live]
(push) ; 4
; [then-branch: 13 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0])]
(assert (not
  (and
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 13 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[0]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[0]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08))))))
...
;  :rlimit-count            125336)
(push) ; 3
; [then-branch: 14 | 0 <= First:(Second:(Second:($t@19@08)))[1] | live]
; [else-branch: 14 | !(0 <= First:(Second:(Second:($t@19@08)))[1]) | live]
(push) ; 4
; [then-branch: 14 | 0 <= First:(Second:(Second:($t@19@08)))[1]]
(assert (<=
  0
  (Seq_index
    ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second $t@19@08))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 14 | !(0 <= First:(Second:(Second:($t@19@08)))[1])]
(assert (not
  (<=
    0
    (Seq_index
...
;  :rlimit-count            127465)
; [then-branch: 15 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1]) | live]
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1] | live]
(push) ; 4
; [then-branch: 15 | !(First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1])]
(assert (not
  (and
    (=
      (Seq_index
...
(pop) ; 4
(push) ; 4
; [else-branch: 15 | First:(Second:(Second:(Second:(Second:($t@19@08)))))[First:(Second:(Second:($t@19@08)))[1]] == 0 && 0 <= First:(Second:(Second:($t@19@08)))[1]]
(assert (and
  (=
    (Seq_index
      ($SortWrappers.$SnapToSeq<Int> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@19@08))))))

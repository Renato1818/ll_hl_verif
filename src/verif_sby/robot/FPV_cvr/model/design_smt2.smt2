...
; yosys-smt2-anyinit robot#1 1 robot_new.sv:37.2-43.5
...
; yosys-smt2-anyinit robot#3 1 robot_new.sv:26.2-32.5
...
(define-fun |robot#6| ((state |robot_s|)) Bool (bvult (|robot#5| state) #b0000000000110010)) ; $lt$robot_new.sv:24$11_Y
...
; yosys-smt2-anyinit robot#11 1 robot_new.sv:70.3-83.6
...
; yosys-smt2-anyinit robot#14 1 robot_new.sv:70.3-83.6
...
; yosys-smt2-anyinit robot#25 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#26 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#27 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#28 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#29 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#30 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#31 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#32 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#33 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-anyinit robot#34 1 robot_new.sv:86.9-111.12
...
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:98$4_EN"], "smtname": 35, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#35| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:98$4_EN
; yosys-smt2-register $formal$robot_new.sv:98$4_EN 1
(define-fun |robot_n $formal$robot_new.sv:98$4_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#35| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:95$3_EN"], "smtname": 36, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#36| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:95$3_EN
; yosys-smt2-register $formal$robot_new.sv:95$3_EN 1
(define-fun |robot_n $formal$robot_new.sv:95$3_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#36| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:89$1_EN"], "smtname": 37, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#37| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:89$1_EN
; yosys-smt2-register $formal$robot_new.sv:89$1_EN 1
(define-fun |robot_n $formal$robot_new.sv:89$1_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#37| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:102$5_EN"], "smtname": 38, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#38| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:102$5_EN
; yosys-smt2-register $formal$robot_new.sv:102$5_EN 1
(define-fun |robot_n $formal$robot_new.sv:102$5_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#38| state)) #b1))
...
(define-fun |robot_c 0| ((state |robot_s|)) Bool (and (= ((_ extract 0 0) (|robot#28| state)) #b1) (= ((_ extract 0 0) (|robot#38| state)) #b1))) ; cov_obs_detected_out_zero
; yosys-smt2-cover 1 cov_obs_detected_out_one
(define-fun |robot_c 1| ((state |robot_s|)) Bool (and (= ((_ extract 0 0) (|robot#27| state)) #b1) (= ((_ extract 0 0) (|robot#38| state)) #b1))) ; cov_obs_detected_out_one
; yosys-smt2-cover 2 cov_dist_zero
(define-fun |robot_c 2| ((state |robot_s|)) Bool (and (= ((_ extract 0 0) (|robot#30| state)) #b1) (= ((_ extract 0 0) (|robot#38| state)) #b1))) ; cov_dist_zero
; yosys-smt2-cover 3 cov_dist_one
(define-fun |robot_c 3| ((state |robot_s|)) Bool (and (= ((_ extract 0 0) (|robot#29| state)) #b1) (= ((_ extract 0 0) (|robot#38| state)) #b1))) ; cov_dist_one
; yosys-smt2-cover 4 cov_alarm_zero
(define-fun |robot_c 4| ((state |robot_s|)) Bool (and (= ((_ extract 0 0) (|robot#26| state)) #b1) (= ((_ extract 0 0) (|robot#38| state)) #b1))) ; cov_alarm_zero
; yosys-smt2-cover 5 cov_alarm_one
(define-fun |robot_c 5| ((state |robot_s|)) Bool (and (= ((_ extract 0 0) (|robot#25| state)) #b1) (= ((_ extract 0 0) (|robot#38| state)) #b1))) ; cov_alarm_one
; yosys-smt2-assert 0 assert_obs_detected_reset
(define-fun |robot_a 0| ((state |robot_s|)) Bool (or (= ((_ extract 0 0) (|robot#34| state)) #b1) (not (= ((_ extract 0 0) (|robot#37| state)) #b1)))) ; assert_obs_detected_reset
; yosys-smt2-assert 1 assert_obs_detected
(define-fun |robot_a 1| ((state |robot_s|)) Bool (or (= ((_ extract 0 0) (|robot#32| state)) #b1) (not (= ((_ extract 0 0) (|robot#36| state)) #b1)))) ; assert_obs_detected
; yosys-smt2-assert 2 assert_alarm_false_reset
(define-fun |robot_a 2| ((state |robot_s|)) Bool (or (= ((_ extract 0 0) (|robot#33| state)) #b1) (not (= ((_ extract 0 0) (|robot#37| state)) #b1)))) ; assert_alarm_false_reset
; yosys-smt2-assert 3 assert_alarm
(define-fun |robot_a 3| ((state |robot_s|)) Bool (or (= ((_ extract 0 0) (|robot#31| state)) #b1) (not (= ((_ extract 0 0) (|robot#35| state)) #b1)))) ; assert_alarm
(define-fun |robot#40| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) #b0 #b1)) ; $0$formal$robot_new.sv:89$1_EN[0:0]$26
(define-fun |robot#41| ((state |robot_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|robot#9| state)) #b1) #b1 #b0)) ; $procmux$88_Y
(define-fun |robot#42| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#41| state) #b0)) ; $0$formal$robot_new.sv:95$3_EN[0:0]$30
(define-fun |robot#43| ((state |robot_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|robot#10| state)) #b1) #b1 #b0)) ; $procmux$98_Y
(define-fun |robot#44| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#43| state) #b0)) ; $0$formal$robot_new.sv:98$4_EN[0:0]$32
(define-fun |robot#45| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#4| state)) #b1) false))) ; $0$formal$robot_new.sv:106$8_CHECK[0:0]$39
(define-fun |robot#46| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#22| state) (ite (|robot#45| state) #b1 #b0))) ; $0$formal$robot_new.sv:89$1_CHECK[0:0]$25
(define-fun |robot#47| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#2| state)) #b1) false))) ; $0$formal$robot_new.sv:109$10_CHECK[0:0]$43
(define-fun |robot#48| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#21| state) (ite (|robot#47| state) #b1 #b0))) ; $0$formal$robot_new.sv:90$2_CHECK[0:0]$27
(define-fun |robot#49| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#13| state)) #b1) false))) ; $logic_not$robot_new.sv:95$48_Y
...
(define-fun |robot#51| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#50| state) (|robot#19| state))) ; $0$formal$robot_new.sv:95$3_CHECK[0:0]$29
(define-fun |robot#52| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#16| state)) #b1) false))) ; $logic_not$robot_new.sv:98$49_Y
...
(define-fun |robot#54| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#53| state) (|robot#23| state))) ; $0$formal$robot_new.sv:98$4_CHECK[0:0]$31
(define-fun |robot#55| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#5| state)) #b1) (= ((_ extract 1 1) (|robot#5| state)) #b1) (= ((_ extract 2 2) (|robot#5| state)) #b1) (= ((_ extract 3 3) (|robot#5| state)) #b1) (= ((_ extract 4 4) (|robot#5| state)) #b1) (= ((_ extract 5 5) (|robot#5| state)) #b1) (= ((_ extract 6 6) (|robot#5| state)) #b1) (= ((_ extract 7 7) (|robot#5| state)) #b1) (= ((_ extract 8 8) (|robot#5| state)) #b1) (= ((_ extract 9 9) (|robot#5| state)) #b1) (= ((_ extract 10 10) (|robot#5| state)) #b1) (= ((_ extract 11 11) (|robot#5| state)) #b1) (= ((_ extract 12 12) (|robot#5| state)) #b1) (= ((_ extract 13 13) (|robot#5| state)) #b1) (= ((_ extract 14 14) (|robot#5| state)) #b1) (= ((_ extract 15 15) (|robot#5| state)) #b1)))) ; $0$formal$robot_new.sv:102$5_CHECK[0:0]$33
(define-fun |robot#56| ((state |robot_s|)) Bool (= (|robot#5| state) #b0111111111111111)) ; $0$formal$robot_new.sv:103$6_CHECK[0:0]$35
...
(define-fun |robot_i| ((state |robot_s|)) Bool (and
  ...
  (= (= ((_ extract 0 0) (|robot#35| state)) #b1) false) ; $formal$robot_new.sv:98$4_EN
  (= (= ((_ extract 0 0) (|robot#36| state)) #b1) false) ; $formal$robot_new.sv:95$3_EN
  (= (= ((_ extract 0 0) (|robot#37| state)) #b1) false) ; $formal$robot_new.sv:89$1_EN
  (= (= ((_ extract 0 0) (|robot#38| state)) #b1) false) ; $formal$robot_new.sv:102$5_EN
...
(define-fun |robot_t| ((state |robot_s|) (next_state |robot_s|)) Bool (and
  (= #b1 (|robot#38| next_state)) ; $procdff$119 $formal$robot_new.sv:102$5_EN
  (= (|robot#40| state) (|robot#37| next_state)) ; $procdff$111 $formal$robot_new.sv:89$1_EN
  (= (|robot#42| state) (|robot#36| next_state)) ; $procdff$115 $formal$robot_new.sv:95$3_EN
  (= (|robot#44| state) (|robot#35| next_state)) ; $procdff$117 $formal$robot_new.sv:98$4_EN

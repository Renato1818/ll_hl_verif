...
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:98$4_EN"], "smtname": 29, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#29| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:98$4_EN
; yosys-smt2-register $formal$robot_new.sv:98$4_EN 1
(define-fun |robot_n $formal$robot_new.sv:98$4_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#29| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:95$3_EN"], "smtname": 30, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#30| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:95$3_EN
; yosys-smt2-register $formal$robot_new.sv:95$3_EN 1
(define-fun |robot_n $formal$robot_new.sv:95$3_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#30| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$robot_new.sv:89$1_EN"], "smtname": 31, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |robot#31| (|robot_s|) (_ BitVec 1)) ; $formal$robot_new.sv:89$1_EN
; yosys-smt2-register $formal$robot_new.sv:89$1_EN 1
(define-fun |robot_n $formal$robot_new.sv:89$1_EN| ((state |robot_s|)) Bool (= ((_ extract 0 0) (|robot#31| state)) #b1))
...
(define-fun |robot#33| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) #b0 #b1)) ; $0$formal$robot_new.sv:89$1_EN[0:0]$26
(define-fun |robot#34| ((state |robot_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|robot#9| state)) #b1) #b1 #b0)) ; $procmux$88_Y
(define-fun |robot#35| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#34| state) #b0)) ; $0$formal$robot_new.sv:95$3_EN[0:0]$30
(define-fun |robot#36| ((state |robot_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|robot#10| state)) #b1) #b1 #b0)) ; $procmux$98_Y
(define-fun |robot#37| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#36| state) #b0)) ; $0$formal$robot_new.sv:98$4_EN[0:0]$32
(define-fun |robot#38| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#4| state)) #b1) false))) ; $0$formal$robot_new.sv:106$8_CHECK[0:0]$39
(define-fun |robot#39| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#22| state) (ite (|robot#38| state) #b1 #b0))) ; $0$formal$robot_new.sv:89$1_CHECK[0:0]$25
(define-fun |robot#40| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#2| state)) #b1) false))) ; $0$formal$robot_new.sv:109$10_CHECK[0:0]$43
(define-fun |robot#41| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#21| state) (ite (|robot#40| state) #b1 #b0))) ; $0$formal$robot_new.sv:90$2_CHECK[0:0]$27
(define-fun |robot#42| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#13| state)) #b1) false))) ; $logic_not$robot_new.sv:95$48_Y
...
(define-fun |robot#44| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#43| state) (|robot#19| state))) ; $0$formal$robot_new.sv:95$3_CHECK[0:0]$29
(define-fun |robot#45| ((state |robot_s|)) Bool (not (or  (= ((_ extract 0 0) (|robot#16| state)) #b1) false))) ; $logic_not$robot_new.sv:98$49_Y
...
(define-fun |robot#47| ((state |robot_s|)) (_ BitVec 1) (ite (|robot#0| state) (|robot#46| state) (|robot#23| state))) ; $0$formal$robot_new.sv:98$4_CHECK[0:0]$31
...
(define-fun |robot_i| ((state |robot_s|)) Bool (and
  ...
  (= (= ((_ extract 0 0) (|robot#29| state)) #b1) false) ; $formal$robot_new.sv:98$4_EN
  (= (= ((_ extract 0 0) (|robot#30| state)) #b1) false) ; $formal$robot_new.sv:95$3_EN
  (= (= ((_ extract 0 0) (|robot#31| state)) #b1) false) ; $formal$robot_new.sv:89$1_EN
...
(define-fun |robot_t| ((state |robot_s|) (next_state |robot_s|)) Bool (and
  (= (|robot#33| state) (|robot#31| next_state)) ; $procdff$111 $formal$robot_new.sv:89$1_EN
  (= (|robot#35| state) (|robot#30| next_state)) ; $procdff$115 $formal$robot_new.sv:95$3_EN
  (= (|robot#37| state) (|robot#29| next_state)) ; $procdff$117 $formal$robot_new.sv:98$4_EN

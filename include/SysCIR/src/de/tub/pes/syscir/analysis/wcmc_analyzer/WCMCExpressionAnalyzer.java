 ...
 *
 */
public class WCMCExpressionAnalyzer {
	
	WCMCExpressionHandler expressionHandler;
	
	public WCMCExpressionAnalyzer(WCMCExpressionHandler expressionHandler){
	...
	public void analyzeExpression(Expression expression, SCClassInstance currentClassInstance){
		...
		if(expression instanceof NewExpression){
			expressionHandler.newExpressionExpressionHandler((NewExpression) expression, currentClassInstance);
		}else
		if(expression instanceof NewArrayExpression){
			expressionHandler.newArrayExpressionExpressionHandler((NewArrayExpression) expression, currentClassInstance);
		}else
		if(expression instanceof DeleteExpression){
			expressionHandler.deleteExpressionExpressionHandler((DeleteExpression) expression, currentClassInstance);
		}else
		if(expression instanceof DeleteArrayExpression){
			expressionHandler.deleteArrayExpressionExpressionHandler((DeleteArrayExpression) expression, currentClassInstance);
		}else{
